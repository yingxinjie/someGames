...
var deskMgr = /** @class */ (function () {
    ...
    */
    ...
    deskMgr.prototype.setCard = function (targetArr, index, value) {
        return __awaiter(this, void 0, void 0, function () {
            var _targets, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = _targets[index].getChildByName("card").getComponent(cc.Sprite);
                        return [4 /*yield*/, exports.DeskMgr.convertPoker(value)];
                    case 1:
    ...
    deskMgr.prototype.setLightDir = function () {
    };
    ...
    deskMgr.prototype.TweenTurnCard = function (target, callback) {
        target.scaleX = 1;
        cc.Tween.stopAllByTarget(target);
        cc.tween(target).to(0.15, { scaleX: 0.1 }).call(callback).to(0.15, { scaleX: 1 }).start();
    };
    deskMgr.prototype.TweenThreeBoard = function (target, callback) {
        target.scaleX = 1;
        cc.Tween.stopAllByTarget(target);
        cc.tween(target).to(0.15, { scaleX: 0.1 }).call(callback).to(0.15, { scaleX: 1 }).start();
    };
